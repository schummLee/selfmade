...
void test_cude_x86()
{
	...
	printf(" CUDA Capability Major/Minor version number:
		 %d.%d\n",
	...
	printf(" Total amount of constant memory:
 		%lu bytes\n",
	deviceProp.totalConstMem);
	printf(" Total amount of shared memory per block:
 		%lu bytes\n",
